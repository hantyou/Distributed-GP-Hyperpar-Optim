...
spmd
    ...
    while iterCount<maxIter
        stillWorkingNeighborNum=sum(neighborWorkingStatus(Agents(m).Neighbors));
        if stillWorkingNeighborNum>0
            ...
            for n=1:N_size
                if Neighbors(n)==0&&neighborWorkingStatus(Agents(m).Neighbors(n))==1
        ...
        end% end of stillWorkingNeighborNum if
    ...
    % %             needTransferInfo=0;
    % %         end
    % %         if sum(neighborWorkingStatus(Agents(m).Neighbors))==0
    % %             needTransferInfo=0;
    % %         end
    % %
    % %         communicationInfoReceiveAgents{m}=[ communicationInfoReceiveAgents{m},communicationInfoReceive];
