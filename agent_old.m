...
% % % % % % % % % Uncommen% t to have cooperation
...
%                 ThisAgent.Ys=ThisAgent.Measurement_self;
%                 ThisAgent.SampleNumber=1;
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
        ...
        function DiffPotential=CalcDiffPotentialU(obj,obj_self)
            ...
            PotentialBorder(abs(PotentialBorder)>50)=PotentialBorder(abs(PotentialBorder)>50).*0.5;
        ...
        function obj=GenerateControl(obj)
            ...
            for i=1:N
                DiffPotential=0*obj.CalcDiffPotentialU(obj(i));
                u_i=-DiffPotential'-k_di*(delta_t/obj(i).gamma)*(obj(i).v);
                for j=obj(i).Neighbour
